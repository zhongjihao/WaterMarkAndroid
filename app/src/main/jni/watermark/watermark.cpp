...
//YV12 -> I420
void WaterMark::Yv12ToI420(unsigned char* pYv12, unsigned char* pI420, int width, int height)
{
...
//I420 -> YV12
void WaterMark::I420ToYv12(unsigned char* pI420, unsigned char* pYv12, int width, int height)
{
...
//NV21 -> I420
void WaterMark::Nv21ToI420(unsigned char* pNv21,unsigned char* pI420,int width,int height)
{
...
//I420 -> NV21
void WaterMark::I420ToNv21(unsigned char* pI420,unsigned char* pNv21,int width,int height)
{
...
//NV12 -> NV21
void WaterMark::Nv12ToNv21(unsigned char* pNv12,unsigned char* pNv21,int width,int height)
{
 ...
 * cutW,cutH 裁剪的分辨率
**/
void WaterMark::cutCommonYuv(int yuvType, int startX,int startY,unsigned char *srcYuv, int srcW,int srcH,unsigned char *tarYuv,int cutW, int cutH)
{
...
**/
void WaterMark::getSpecYuvBuffer(int yuvType,unsigned char *dstBuf, unsigned char *srcYuv, int srcW, int srcH,int dirty_Y,int dirty_UV)
{
    int i;
    switch(yuvType){
        case FORMAT_NV21:
 ...
 * yuvW,yuvH 源YUV的分辨率
**/
void WaterMark::yuvAddWaterMark(int yuvType, int startX, int startY, unsigned char *waterMarkData,
